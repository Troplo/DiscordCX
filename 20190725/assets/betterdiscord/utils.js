...
module.exports = class Utils {
	...
	static async getCommitHash(repo, branch) {
		const url = this.formatString("https://api.github.com/repos/{{repo}}/BetterChatXApp/commits/{{branch}}", {repo, branch});
    ...
    static async getUpdater(repo, branch) {
		...
		const url = this.formatString("https://cdn.statically.io/gh/{{repo}}/BetterChatXApp/{{hash}}/betterChatX/config.json", {repo, hash});
    ...
    static _log(message) {
        console.log("[BetterChatX]" + message);
