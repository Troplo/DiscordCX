...
Object.assign(config, {
    os: process.platform,
    dataPath: (process.platform == "win32" ? process.env.APPDATA : process.platform == "darwin" ? process.env.HOME + "/Library/Preferences" :  process.env.XDG_CONFIG_HOME ? process.env.XDG_CONFIG_HOME : process.env.HOME + "/.config") + "/BetterChatX/"
});
...
const BetterChatX = class BetterChatX {
    ...
    get externalData() {
        return [
            ...
            {
                type: "style",
                url: "//cdn.staticaly.com/gh/{{repo}}/BetterChatXApp/{{hash}}/css/main{{minified}}.css",
                backup: "//rauenzi.github.io/BetterChatXApp/css/main{{minified}}.css",
                local: config.localServer + "/BetterChatXApp/css/main.css"
            },
            {
                type: "script",
                url: "//cdn.staticaly.com/gh/{{repo}}/BetterChatXApp/{{hash}}/js/main{{minified}}.js",
                backup: "//rauenzi.github.io/BetterChatXApp/js/main{{minified}}.js",
                local: config.localServer + "/BetterChatXApp/js/main.js"
            }
        ];
    }
